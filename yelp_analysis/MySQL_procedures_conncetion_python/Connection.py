...
def get_business_name_from_ids(business_id):
    conn = get_connection()
    cur = conn.cursor()
    r = cur.execute('CALL get_name_from_id("{0}")'.format(business_id))
    return cur.fetchone()[0]

#print(get_business_name_from_ids('4JNXUYY8wbaaDmk3BPzlWw'))
